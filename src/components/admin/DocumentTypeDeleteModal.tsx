...
import { DocumentTypeDeleteModalProps } from '../../types/document-type';

export function DocumentTypeDeleteModal({
  documentType,
  isOpen,
  onClose,
  onConfirm,
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
          ...
          <div className="px-6 py-4">
            <Text className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              <strong>"{documentType.title}"</strong>? This action cannot be
              undone.
            </Text>
          </div>
