...
import { DocumentRequestConfirmationModalProps } from '../../types/document-request-confirmation';

export function DocumentRequestConfirmationModal({
  documentRequest,
  isOpen,
  onClose,
  onConfirm,
  okLabel,
  loading,
}: DocumentRequestConfirmationModalProps) {
  ...
  if (!isOpen || !documentRequest) return null;
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            ...
            >
              {okLabel} Document Request
            </Heading>
          </div>

          <div className="px-6 py-4">
            <Text className="text-gray-700 dark:text-gray-300 mb-4">
              Are you sure you want to {okLabel} this document request? This
