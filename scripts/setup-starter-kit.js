 ...
 *
 * This script helps set up a community civic information portal from the
 * starter kit while keeping the portal identity separate from the government.
 */
...
async function setupStarterKit() {
  console.log('🏛️  Community Civic Portal Starter Kit Setup');
  console.log('===============================================\n');

  // Collect government information
  console.log('Please provide your portal and local government information:\n');

  const siteName = await askQuestion('Portal Name (e.g., "Better Gattaran"): ');
  ...
  const envContent = `# Community Civic Information Portal Configuration
# Generated by setup script

# Portal Identity
VITE_SITE_NAME="${siteName}"
VITE_SITE_DESCRIPTION="A community-driven civic information portal for ${governmentName}."
...
# Social Media (Optional; add only verified portal or government accounts)
VITE_FACEBOOK_URL=""
VITE_TWITTER_URL=""
VITE_INSTAGRAM_URL=""
VITE_YOUTUBE_URL=""
